...
from transformers import BertModel, AutoModelForSequenceClassification,AutoModelForTokenClassification
...
#         x, _ = self.encoder(x)      #input shape:(batch_size, sen_len, input_dim)
