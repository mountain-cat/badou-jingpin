...
'''
Author: Shiyao Ma
Date: 2023-09-09 16:26:30
LastEditors: Shiyao Ma
LastEditTime: 2023-09-09 16:50:33
...
class SiameseNetwork(nn.Module):
    ...
    def forward(self, sentence1, sentence2=None, sentence3=None):
        """ Calculate tripletloss among 3 sentences, no need to pass target
        """
        if sentence2 is not None and sentence3 is not None:
            ...
            return self.sentence_encoder(sentence1)             # return sentence1's embeddings only.
