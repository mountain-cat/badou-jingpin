...
bert = BertModel.from_pretrained(r"C:\Users\jason\.cache\huggingface\hub\models--bert-base-chinese\snapshots\8d2a91f91cc38c96bb8b4556ba70c392f8d5ee55", return_dict=False)
...
class DiyBert:
    ...
    def single_transformer_layer_forward(self, x, layer_index):
        ...
        # GPTJ Implementation
        x_ff = self.feed_forward(x, intermediate_weight, intermediate_bias, output_weight, output_bias)
        x = self.layer_norm(attention_output + x_ff + x, ff_layer_norm_w, ff_layer_norm_b)
