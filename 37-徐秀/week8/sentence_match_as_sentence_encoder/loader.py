...
class DataGenerator:
    ...
    def random_train_sample(self):
        ...
        if len(self.knwb[p]) < 2:
            ...
            point_a = random.choice(self.knwb[p])
            point_p = random.choice(self.knwb[p])
            point_n = random.choice(self.knwb[n])
            return [point_a, point_p, point_n]
